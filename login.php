...
$query=mysqli_query($con,"insert into users(name,email,contactno,password,shippingAddress,shippingState,shippingCity,shippingPincode) values('$name','$email','$contactno','$password','$shippingaddress','$shippingstate','$shippingcity','$shippingpincode')");
$check="insert into users(name,email,contactno,password,shippingAddress,shippingState,shippingCity,shippingPincode) values('$name','$email','$contactno','$password','$shippingaddress','$shippingstate','$shippingcity','$shippingpincode";
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in </h4> <?php include('update_password.php'); ?> 
