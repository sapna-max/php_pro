...
mysqli_query($con,"insert into orders(userId,productId,quantity,orderDate,grand_total,orderStatus) values('".$_SESSION['id']."','$qty','$val34',NOW(),'".$_SESSION['tp']."','0')");
 ...
 $pdtid=array();
    $sql = "SELECT * FROM tbl_product WHERE id IN(";
			...
			while($row = mysqli_fetch_array($query)){
				...
				$subtotal= $_SESSION['cart'][$row['id']]['quantity']*$row['product_price']+$row['shipping_charge'];
				$totalprice += $subtotal;
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin2/productimages/<?php echo $row['id'];?>/<?php echo $row['product_img1'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['product_price']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['shipping_charge']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['product_price']+$row['shipping_charge']); ?>.00</span></td>
				</tr>
...
while ($rt=mysqli_fetch_array($qry)) {
	...
	$_SESSION['emailid']=htmlentities($rt['email']);
