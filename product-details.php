...
<?php
$ret=mysqli_query($con,"select  tbl_category.category_name as catname,tbl_subcategory.sub_category as subcatname,tbl_product.product_name as pname from tbl_product join tbl_category on tbl_category.id=tbl_product.category_id join tbl_subcategory on tbl_subcategory.id=tbl_product.subcategory_id where tbl_product.id='$pid'");
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php $sql=mysqli_query($con,"select id,category_name  from tbl_category");
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['product_name']);?>/<?php echo htmlentities($rws['product_img1']);?>"  width="200" height="334" alt="">
							</div>
							
						</div><!-- /.hot-deal-wrapper -->

						<div class="product-info text-left m-t-20">
							<h3 class="name"><a href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['product_name']);?></a></h3>
							<div class="rating rateit-small"></div>

							<div class="product-price">	
								<span class="price">
									Rs. <?php echo htmlentities($rws['product_price']);?>.00
								</span>
...
<?php 
$ret=mysqli_query($con,"select * from tbl_product where id='$pid'");
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['product_name']);?>" href="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img1']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img2']);?>" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img3']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img3']);?>" />
                </a>
            </div>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive"  alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img1']);?>" />
                    </a>
                </div>

            <div class="item">
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img2']);?>"/>
                    </a>
                </div>
                <div class="item">

                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin2/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['product_img3']);?>" height="200" />
                    </a>
                </div>
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name"><?php echo htmlentities($row['product_name']);?></h1>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['product_availiability']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php if($row['shipping_charge']==0)
											{
												echo "Free";
											}
											else
											{
												echo htmlentities($row['shipping_charge']);
											}
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">Rs. <?php echo htmlentities($row['product_price']);?></span>
											<span class="price-strike">Rs.<?php echo htmlentities($row['product_discount']);?></span>
										</div>
									</div>
